...
function zoom!(size::window, (y_mousepos, x_mousepos), rate::Real = 0.99, sensitivity::Real = 0.1)
    ...
    size.x_min = new_x_min
    size.x_max = new_x_max
    size.y_min = new_y_min
    size.y_max = new_y_max

end

function main()
    GLMakie.activate!()
    window_param = window(-1.125, 1.125, -2.5, 1.5, 1080, 1920)
